...
type ChallengeModalProps = {
  open: boolean;
  onClose: () => void;
  onSubmit: (opts: { scopeType: "open" | "ens"; scopedEnsName?: string }) => Promise<void>;
  loading: boolean;
  error: string | null;
};
      ...
      >
        ...
        <div className="px-6 py-5" style={{ borderBottom: "3px dashed #455A64", opacity: 0.8 }}>
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <TermChip label="Capital" value="$100" />
          </div>
        </div>
        ...
        <div className="px-6 py-5">
          <button
            ...
            disabled={loading || (scopeType === "ens" && !ensName.trim())}
            className="neo-btn w-full py-4"
            style={{
              fontSize: "16px",
              letterSpacing: "0.12em",
              opacity: loading || (scopeType === "ens" && !ensName.trim()) ? 0.4 : 1,
              cursor: loading || (scopeType === "ens" && !ensName.trim()) ? "not-allowed" : "pointer",
            }}
          >
